...
{data.length != 0 ? <table className={styles.table} style={{width:"100%", borderCollapse: "collapse;" ,borderRadius:"6px 6px 0px 0px !important"}}>
  <thead className={styles.thead}>
    <tr>
      ...
      <th className={styles.th} style={{borderRadius:"0px 0px 0px 0px !important"}}><span className={styles.hspan}> <figure className={styles.dlogo}><Image priority src={g5} alt="logo" layout="fill" objectFit="contain"/></figure><p className={styles.p}>Category D</p></span></th>
      <th className={styles.th} style={{borderRadius:"0px 6px 0px 0px !important"}}><span className={styles.hspan}> <figure className={styles.clogo}><Image priority src={g4} alt="logo" layout="fill" objectFit="contain"/></figure><p className={styles.p}>Category E</p></span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
